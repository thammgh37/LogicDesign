...
uint8_t b_stay[1][8]= 	{			{ 0x3E,0x66,0x66,0x3E,0x66,0x66,0x3E,0x00} };//3e66663e66663e00


uint8_t b_run[14][8]={ 					{ 0x3E,0x66,0x66,0x3E,0x66,0x66,0x3E,0x00},//3e66663e66663e00
										{ 0x1F,0x33,0x33,0x1F,0x33,0x33,0x1F,0x00},//1f33331f33331f00
										{ 0x0F,0x19,0x19,0x0F,0x19,0x19,0x0F,0x00},//0f19190f19190f00
										{ 0x07,0x0C,0x0C,0x07,0x0C,0x0C,0x07,0x00},//070c0c070c0c0700
										{ 0x03,0x06,0x06,0x03,0x06,0x06,0x03,0x00},//0306060306060300
										{ 0x01,0x03,0x03,0x01,0x03,0x03,0x01,0x00},//0103030103030100
										{ 0x00,0x01,0x01,0x00,0x01,0x01,0x00,0x00},//0001010001010000
										{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},//0000000000000000
										{ 0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x00},//8080808080808000
										{ 0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0x00},//c0c0c0c0c0c0c000
										{ 0xE0,0x60,0x60,0xE0,0x60,0x60,0xE0,0x00},//e06060e06060e000
										{ 0xF0,0x30,0x30,0xF0,0x30,0x30,0xF0,0x00},//f03030f03030f000
										{ 0xF8,0x98,0x98,0xF8,0x98,0x98,0xF8,0x00},//f89898f89898f800
										{ 0x7C,0xCC,0xCC,0x7C,0xCC,0xCC,0x7C,0x00}//7ccccc7ccccc7c00
};
...
void displayLedMatrix_green(int index1, int index2, uint8_t buffer[][8]){
	...
	case 0:
		...
		writeByte(gENM0_GPIO_Port, cot_green, 0X01);
		writeByte(ROW0_GPIO_Port, hang, buffer[index1][index2]);
		break;
	case 1:
